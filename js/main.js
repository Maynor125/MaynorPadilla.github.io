...
window.addEventListener('scroll',scrollHeader)
 ...
 document.addEventListener("DOMContentLoaded", function(){
  const proyectos = [
    ...
    {
      nombre: "Sistema SGFS",
      imagen: "./img/project/ferreteria.png",
      categoria: "Apps",
      fecha:"17 de mayo del 2022",
      tecnologias: ["C#","MySQL","Bonifu"],
